...
const Hero = styled.div`
  ...
  .table-footer-first, .table-footer-second {
    font-weight: bold;
  }
...
const _defaultCosts = [
  {
    liabilites: "As Guarantor, Endorser, or Co-maker",
    amount: "",
  },
  {
    liabilites: "On Leases or Contracts ",
    amount: "",
  },
  {
    liabilites: "Legal Claims",
    amount: "",
  },
  {
    liabilites: "  Provisions for Federal Income Taxes",
    amount: "",
  },
  {
    liabilites: "Other Special Debt",
    amount: "",
  },
];
      ...
      <ProGressTracker />
        <section className="Form-design">
          ...
          <div className="table-header">
            <p className="table-header-one">Liabilities</p>
          ...
          <div className="table-form">
            {costs.map((item, index) => (
              <table key={index}>
                <tbody>
                  <tr>
                    <th className="thead">{item.liabilites}</th>
                    <th>
                      <input
                        name="amount"
                        data-id={index}
        ...
        <div className="form-row-button">
            <input
              ...
              value="Continue"
            />
            <a href="/personalfinance_bs">Skip</a>
          </div>
      </Hero>
    </>
  );
