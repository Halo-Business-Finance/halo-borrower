...
const WorkingCapitalForm = () => {
	...
	const completeFormStep = () => {
		if (workingCapitalData.bankruptcyYear == "0" || workingCapitalData.businessYear == "0" || Number(workingCapitalData.annualRevenue) < 200000 || workingCapitalData.creditScore == "score1") {
